...
export default function Home() {
  return (
    <>
      ...
      <div
        className="flex min-h-screen flex-col gap-8 px-5 py-8 sm:gap-16
          sm:px-12 sm:py-16 lg:gap-24 lg:px-20 lg:py-24"
      >
        <NextByVercel />
        ...
        <div
          className="mx-auto grid max-w-[1100px] grid-cols-1 sm:grid-cols-2
            lg:grid-cols-4"
        >
          <BoxLink
