  ...
  return (
    <a
      ...
      className={classNames(
        `group rounded-xl border border-solid border-zinc-500/0 bg-gray-400/0 py-4 px-10 transition-colors
        duration-200 ease-ease dark:border-stone-300/0 dark:bg-stone-500/0 tablet:px-[19.2px]
